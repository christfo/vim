...
function! s:DefaultHighlightings()
    highlight def StatusLineInsert             term=bold,reverse cterm=bold,reverse ctermfg=Red  gui=bold,reverse guifg=Red
    highlight def StatusLineModified           term=bold,reverse cterm=bold,reverse ctermfg=magenta  gui=bold,reverse guifg=magenta
    highlight def StatusLineModifiedNC         term=reverse      cterm=reverse      ctermfg=magenta  gui=reverse      guifg=magenta
...
augroup StatusLineHighlight
    autocmd!
    autocmd CursorMoved,BufWinEnter,WinEnter,CmdwinEnter,BufWritePost * call <SID>StatusLineHighlight(1)
    ...
    autocmd InsertEnter * call <SID>SetHighlight('Insert')
    autocmd InsertLeave * call <SID>StatusLineHighlight(1)
