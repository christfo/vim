...
" call arpeggio#map('n', 's', 0, 'lh', ':History<CR>')
...
"call arpeggio#map('n', 's', 0, 'kf', ':BLines<CR>')
call arpeggio#map('n', 's', 0, 'kf', ":exe 'BLines '.expand('<cword>')<CR>")
...
call arpeggio#map('n', 's', 0, 'kd', ':Files<CR>')
